...
(function($) {
    ...
    $.validity = {
        ...
        messages:{
            ...
            require:"#{field} debe ser completado.",
            // Format validators:
            ...
            greaterThanOrEqualTo:"#{field} debe tener más de #{min} caracteres.",
            ...
            maxCharClass:"#{field} no podrá tener menos que #{min} #{charClass} caracteres.",
