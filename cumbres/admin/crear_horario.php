...
<table border="1" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="100" height="40" bgcolor="#333333"><div align="center" class="Estilo6">Domingo</div></td>
  </tr>
<?php  
...
where asig_bloque.id_ramo = asignatura.id and bloque.nombre = asig_bloque.nombre_bloque and asig_bloque.dia=$dia_horario and asig_bloque.nombre_bloque='$nombre_bloque'
",$conn);
