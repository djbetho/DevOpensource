...
<div id="step-holder">
			...
			<div class="step-dark-left"><a href="">Datos del Alumno</a></div>
 			<div class="step-light-round">&nbsp;</div>
</div>

   
<form id="formUsuario" name="formUsuario" method="post" action="reg_alumno.php">
  <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
      <tr>
        ...
        <th><input name="button" type="button" class="form-verificar" id="button" value="" onClick="javascript:ComprobarUsuario('./comprobarUser.php','estadoUser')" /></th>
        <td><div class="error-left"></div>
			<div id="estadoUser" class="error-inner"></div></td>
      </tr>
      <tr>
      ...
      <tr>
        <th valign="top"><span class="Estilo3">Comentario:</span></th>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td><textarea name="comentario" cols="" rows="" class="form-textarea" id="comentario"></textarea></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
	...
	<div class="bubble-right"></div></td>
      ...
      <tr>
        <th valign="top"><span class="Estilo3">Curso:</span></th>
        <td><select name="id_curso" size="1" id="id_curso">
          <?php
