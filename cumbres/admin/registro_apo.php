...
<form id="formUsuario" name="formUsuario" method="post" action="text.php?p=registro_apo_php">
  ...
  <th><input name="button" type="button" class="form-verificar" id="button" value="" onClick="javascript:ComprobarUsuario('./comprobarApo.php','estadoUser')" /></th>
